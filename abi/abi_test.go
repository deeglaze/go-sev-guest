...
func testRawCertTableNoVcek(t testing.TB) *testCertTable {
	...
	headers[0].GUID = MustParseGUID(extraGUID)
	headers[0].Offset = uint32(len(headers) * CertTableEntrySize)
